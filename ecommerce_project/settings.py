...
SECRET_KEY = 'django-insecure-+ik9h-g7vsqw7)s=#1m(7pp^s!lwmoo()x#0x^9a@!qahv=&sb'
...
DATABASES = {
    'default': {
        ...
        'CLIENT' : {
            'host' : 'mongodb+srv://mmperlado:mmperlado@cluster0.8riwarj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
        }
    }
}
